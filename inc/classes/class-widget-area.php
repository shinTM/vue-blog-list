...
if ( ! class_exists( '__Tm_Widget_Area' ) ) {
	...
	class __Tm_Widget_Area {
		...
		function __construct() {
			...
			add_action( '__tm_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			/**
			 * Footer widget area visibility check.
			 *
			 * @since 1.3.2
			 */
			$footer_area_visibility = get_theme_mod( 'footer_widget_area_visibility', __tm_theme()->customizer->get_default( 'footer_widget_area_visibility' ) );
