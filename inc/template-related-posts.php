 ...
 * @return array
 */
function __tm_related_posts() {

	if ( ! is_singular( 'post' ) ) {
		return;
	}

	$visible = get_theme_mod( 'related_posts_visible', __tm_theme()->customizer->get_default( 'related_posts_visible' ) );
	...
	$post_terms  = array();
	$post_number = get_theme_mod( 'related_posts_count', __tm_theme()->customizer->get_default( 'related_posts_count' ) );
	...
	foreach ( $settings as $setting_key => $setting_value ) {
		$settings[ $setting_key ] = get_theme_mod( $setting_value, __tm_theme()->customizer->get_default( $setting_value ) );
	}

	$settings['title_visible']   = $settings[ 'title_length' ] ? get_theme_mod( 'related_posts_title', __tm_theme()->customizer->get_default( 'related_posts_title' ) ) : false;
