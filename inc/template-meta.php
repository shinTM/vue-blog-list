 ...
 * @return array
 */
function __tm_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	$default_config = apply_filters( '__tm_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( '__tm_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', '__tm' ) . $network['name'],
